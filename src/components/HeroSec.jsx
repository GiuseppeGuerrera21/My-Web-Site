...
export default function HeroSec() {
    ...
    return (
        <>
            ...
            >
                <div className="relative z-10 flex flex-col md:-space-y-3 lg:-space-y-6 lg:ps-32 ps-10 -mt-42 md:-mt-50 -ms-10 lg:ms-0 lg:mt-0">
                    ...
                    <div className="flex flex-row pt-5 md:pt-8 lg:pt-13 gap-7">
                        {customSvg.map((item, index) => (
                            <a key={index} href={item.link}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="white" x="0px" y="0px" className="w-10 h-10 md:w-14 md:h-14" viewBox="0 0 50 50">
                ...
                <img
                    className="absolute md:block w-[260px] md:w-[400px] lg:w-[480px] bottom-0 -right-8 md:right-0 lg:right-26"
                    src={me}
                    alt="Foto di me stesso"
                />
            </header>
            <img className="absolute top-0 left-0" src={blob1} alt="Blob 1"  />
            <img className="absolute top-160 right-0" src={blob2} alt="Blob 2"  />
        </>
    );
}
