        ...
        <>
            <header id="home" className="relative z-10 w-full h-screen bg-[url('/bg.png')] bg-cover bg-center">
                <div className="flex flex-col items-start -space-y-8 justify-center h-full ps-32">
                    <p className="text-2xl text-white ps-1 pb-4">HELLO I’M</p>
                    <h1 className=" text-[90px] font-bold text-white">Giuseppe Guerrera </h1>
                    <h2 className=" text-[78px] font-bold text-white">Full Stack Developer</h2>
                    <p className="text-2xl text-white pt-8">BASED IN BARI</p>
                </div>
