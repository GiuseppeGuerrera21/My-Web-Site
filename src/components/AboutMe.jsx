...
export default function AboutMe() {
    ...
    return (
        <>
            <section id="about" className="relative z-20 min-h-screen grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 items-center space-y-24 md:space-y-0 mt-26 lg:mt-0">
