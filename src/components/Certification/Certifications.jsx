    ...
    return (
        ...
        >
            <div className="space-y-6 px-7">
                ...
                <p className="text-xl lg:w-3/4 mx-auto leading-relaxed p-6 backdrop-blur-sm bg-black/5 shadow-xl rounded-2xl">Ecco le certificazioni che ho ricevuto: una per un corso di programmazione intensivo con Aulab e un’altra per un corso di React (71.5 ore) acquistato su Udemy. Clicca su una di esse per maggiori dettagli</p>
            </div>
            <CardGrid />
        </section>
    )
