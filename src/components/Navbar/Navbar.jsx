                    ...
                    {navLinks.slice(0, 4).map((item, index) => (
                        <div key={index} className="relative">
                            <a
                                ...
                                className="relative text-white px-3 py-2 pb-4 transition-all duration-300 ease-in-out"
                            >
                                <span className="relative z-10">{item.name}</span>
                                {activeIndex === index && (
                                    <motion.span
                                        layoutId="background"
                                        className="absolute -inset-x-2 -inset-y-1 top-0 bottom-2 rounded-2xl bg-gradient-to-t from-white to-transparent"
