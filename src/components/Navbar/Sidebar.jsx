...
export default function Navbar() {
    ...
    return (
        <nav className="md:hidden top-0 left-0 w-full h-full flex items-center justify-center">
            <button
            ...
            <div className="relative -z-50 ">
                ...
                {/* Menu Sidebar */}
                <ul
                    className={`fixed top-0 left-0 w-full h-full bg-background/10 backdrop-blur-xs flex flex-col items-center justify-center space-y-6 text-xl transform transition-transform duration-500 ${isOpen ? "translate-y-0" : "-translate-y-full"
                        }`}
                >
