...
export default function Lanyard({ position = [0, 0, 30], gravity = [0, -40, 0], fov = 20, transparent = true }) {
    ...
    return (
        <div ref={containerRef} className="absolute w-full h-screen flex justify-center items-center transform scale-100 origin-center">
            {isVisible && (
                <Canvas
...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
    ...
    const texture = useTexture(guerrera);
