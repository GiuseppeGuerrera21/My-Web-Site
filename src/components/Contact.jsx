...
export default function Section() {
    return (
        <>
            <section
                id="contact"
                className="relative min-h-screen grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 items-center space-y-24 md:space-y-0 pt-20 lg:mt-0"
                style={{ backgroundImage: `url(${bg})` }}
            >
                <div className="flex flex-col px-10 md:px-20 lg:text-start lg:ps-28 lg:px-32">
                    <h2 className="text-5xl font-title pb-3 ps-6">Contatti</h2>
